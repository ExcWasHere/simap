...
@section('deskripsi')
    Halaman ini hilang seperti camilan di meja kantor. Ayo kita cari yang lain!
@endsection
...
@section('konten')
    ...
    >
        <h5 class="cursor-default font-bold text-3xl text-red-700">404 | Halaman Tidak Ditemukan</h5>
