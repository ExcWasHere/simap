@auth
    <footer class="mx-auto container flex items-center justify-between w-full px-4 py-3 bg-white shadow-md">
        ...
        <section class="cursor-default text-center text-sm text-gray-500">
