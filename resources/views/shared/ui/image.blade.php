<section class="w-1/2 relative hidden lg:inline">
    ...
    <figure class="absolute z-20 bottom-8 left-8 text-white space-y-2">
        <img
            ...
            loading="lazy"
        />
        <h4 class="cursor-default text-2xl font-bold tracking-tight">Direktorat Jenderal Bea dan Cukai</h4>
        <h6 class="cursor-default text-sm text-gray-200">Kantor Pengawasan dan Pelayanan Bea dan Cukai TMP C Blitar</h6>
