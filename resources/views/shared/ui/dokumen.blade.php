...
<div class="container mx-auto px-4 py-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        @forelse($documents as $document)
            <div
                class="group relative bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
                <form action="{{ route('dokumen.delete', $document->id) }}" method="POST"
                    ...
                    <div class="p-6 flex flex-col items-center justify-center h-40 space-y-3">
                        @if (Str::endsWith($document->file_path, '.pdf'))
                            <div class="relative">
                                ...
                                <div
                                    class="absolute -bottom-1 -right-1 w-5 h-5 bg-red-100 rounded-full flex items-center justify-center">
                        ...
                        @elseif(Str::endsWith($document->file_path, ['.doc', '.docx']))
                            <div class="relative">
                                ...
                                <div
                                    class="absolute -bottom-1 -right-1 w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center">
                        ...
                        @elseif(Str::endsWith($document->file_path, ['.xls', '.xlsx']))
                            <div class="relative">
                                ...
                                <div
                                    class="absolute -bottom-1 -right-1 w-5 h-5 bg-green-100 rounded-full flex items-center justify-center">
                        ...
                        @else
                            <div class="relative">
                                ...
                                <div
                                    class="absolute -bottom-1 -right-1 w-5 h-5 bg-gray-100 rounded-full flex items-center justify-center">
        ...
        <div class="group relative bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-xl border-2 border-dashed border-blue-200 hover:border-blue-300 transition-all duration-300 cursor-pointer"
            ...
            <div
                class="absolute inset-0 bg-blue-500/0 group-hover:bg-blue-500/[0.02] rounded-xl transition-colors duration-300">
            </div>
            <div class="p-6 flex flex-col items-center justify-center h-40 space-y-3">
                <div class="relative">
                    <i
