...
@section('konten')
    ...
    <section class="container mt-16 max-w-7xl mx-auto shadow rounded-lg pb-10 pt-6 px-10 sm:px-6 md:px-8">
        ...
        <form id="formulir-tambah-data" class="space-y-6" method="POST" action="{{ route('data.store') }}">
            ...
            @include('shared.ui.navigation', [
                'tabs' => [
                    [
                        'id' => 'intelijen',
                        'label' => 'Intelijen',
                        'active' => $active_tab === 'intelijen',
                    ],
                    [
                        'id' => 'penyidikan',
                        'label' => 'Penyidikan',
                        'active' => $active_tab === 'penyidikan',
                    ],
                    [
                        'id' => 'penindakan',
                        'label' => 'Penindakan',
                        'active' => $active_tab === 'penindakan',
                    ],
                ],
            ])
            ...
            {{-- Penyidikan --}}
            <section
                class="tab-content {{ $active_tab === 'penyidikan' ? 'active' : 'hidden' }}"
                id="penyidikan-content"
                data-content="penyidikan"
            >
                <div class="grid grid-cols-1 gap-6">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function activateTab(tabId) {
                    if (entityInput) entityInput.value = tabId;
                ...
                if (initialTab) activateTab(initialTab.getAttribute('data-tab'));
            });
        </script>
    @endpush
@endsection