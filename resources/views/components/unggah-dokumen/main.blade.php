...
<section
    id="modal-upload"
    class="fixed z-50 grid place-items-center h-full w-full overflow-y-auto min-h-screen inset-0 py-8 text-center"
...
>
    ...
    <article class="relative w-3/4 rounded-lg shadow-xl px-8 py-4 bg-white lg:w-1/2">
